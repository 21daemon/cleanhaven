...
import { ArrowRight, Car, Check, Clock, CreditCard, Shield, Star, Zap } from 'lucide-react';
...
const Index: React.FC = () => {
  ...
  const reviews = [
    ...
    {
      name: "Sarah Johnson",
      content: "I've tried multiple detailing services, and CleanHaven stands above them all. Professional, thorough, and worth every penny.",
      rating: 5,
    },
    {
      name: "David Chen",
  ...
  const features = [
    {
      ...
      description: "Every service comes with our satisfaction guarantee",
    },
    {
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto animate-slide-up animation-delay-100">
                Choose from our range of premium car detailing services, each designed to restore and protect your vehicle.
              </p>
            </div>
        ...
        <section className="py-20 bg-secondary/50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4 animate-slide-up">
                The CleanHaven Difference
              </h2>
              <p className="text-muted-foreground max-w-2xl mx-auto animate-slide-up animation-delay-100">
                We're not just cleaning cars; we're providing an experience that redefines what car care should be.
              </p>
            </div>
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto animate-slide-up animation-delay-100">
                Don't just take our word for it—hear from customers who've experienced the CleanHaven difference.
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="mb-8 md:mb-0 md:mr-8 text-center md:text-left">
                ...
                <p className="max-w-lg opacity-90 animate-slide-up animation-delay-100">
                  Book your appointment today and experience the premium car care that's setting a new standard.
                </p>
              </div>
              <Link to="/booking">
                <Button 
