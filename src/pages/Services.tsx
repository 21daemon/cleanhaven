...
import { Car, Droplets, Paintbrush, Scissors, SprayCan, SquareAsterisk, Shrub, Wind, Check, Clock } from 'lucide-react';
...
const Services: React.FC = () => {
  const services = [
    {
      title: "Basic Wash",
      description: "Thorough exterior wash, wheel cleaning, and hand drying.",
      price: "$49.99",
    ...
    },
    {
      ...
      description: "Deep cleaning of all interior surfaces, including seats, carpets, and trim.",
      price: "$79.99",
      imageUrl: "https://images.unsplash.com/photo-1620548955247-b5e9696e8b31?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1600&q=80",
      icon: <Wind />,
      features: [
        "Vacuum all surfaces",
    ...
    },
    {
      ...
      description: "Complete interior & exterior detail with hand wax finish.",
      price: "$99.99",
      imageUrl: "https://images.unsplash.com/photo-1600275670624-88912902fbdb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1600&q=80",
      icon: <Shrub />,
      features: [
        "Basic wash service",
    ...
    },
    {
      ...
      price: "$69.99",
      imageUrl: "https://images.unsplash.com/photo-1596804795243-23b31a0b68a8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1600&q=80",
      icon: <Scissors />,
      features: [
        "Full exterior wash",
    ...
    },
    {
      ...
      description: "Machine polishing to remove swirls, scratches, and imperfections.",
      price: "$199.99",
  ...
  const packages = [
    {
      ...
      description: "Protect your investment from day one with our comprehensive new car package.",
      price: "$299.99",
      features: [
    ...
    },
    {
      ...
      description: "Maximize your car's value with our complete pre-sale detailing package.",
      price: "$249.99",
      features: [
    ...
    },
    {
      ...
      description: "Prepare your vehicle for changing weather conditions with specialized protection.",
      price: "$179.99",
      features: [
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <PageTransition>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground animate-slide-up animation-delay-100">
                Experience the difference with our range of professional detailing services, each tailored to meet your specific needs and exceed expectations.
              </p>
              
              <div className="mt-8 flex flex-wrap gap-4 justify-center animate-slide-up animation-delay-200">
                <Link to="/booking">
                  <Button size="lg" className="hover-lift">Book a Service</Button>
                </Link>
                <a href="#packages">
                  <Button variant="outline" size="lg" className="hover-lift">View Packages</Button>
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Choose from our selection of individual services to keep your vehicle looking its best.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, index) => (
                <div
                  key={service.title}
                  className={`border rounded-xl overflow-hidden bg-white hover-lift animate-blur-in animation-delay-${index * 100}`}
                >
        ...
        <section id="packages" className="py-20 bg-secondary/50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold mb-4">Specialty Packages</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Our curated packages combine our most popular services for specific needs and maximum value.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {packages.map((pkg, index) => (
                <div
                  key={pkg.title}
                  className={`border rounded-xl p-8 bg-white relative hover-lift animate-slide-up animation-delay-${index * 100} ${
                    pkg.recommended ? "ring-2 ring-primary" : ""
                  }`}
                >
                  {pkg.recommended && (
                    <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                      <span className="inline-block px-4 py-1 text-xs font-medium bg-primary text-primary-foreground rounded-full">
                        Recommended
                      </span>
                    </div>
                  )}
                  ...
                  <Link to="/booking">
                    <Button 
                      className={`w-full ${pkg.recommended ? "" : "variant-outline"}`}
