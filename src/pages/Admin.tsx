...
const Admin: React.FC = () => {
  ...
  }, [isAdmin, bookingsPage, feedbackPage, bookingsFilter, statusFilter, ratingFilter]);
  ...
  const fetchBookings = async () => {
    ...
    try {
      ...
      if (bookingsFilter) {
        query = query.or(`car_make.ilike.%${bookingsFilter}%,car_model.ilike.%${bookingsFilter}%`);
      }
      ...
      const { data, error, count } = await query
        ...
        .range((bookingsPage - 1) * PAGE_SIZE, bookingsPage * PAGE_SIZE - 1);
            ...
            <div className="flex flex-wrap justify-between items-center gap-4">
              <div>
                ...
                <p className="text-muted-foreground">
                  Manage bookings and customer feedback for Autox24.
                </p>
              </div>
              {isSuperAdmin && (
          ...
          <Tabs defaultValue="bookings" className="w-full">
            ...
            <TabsContent value="bookings">
              <div className="bg-white rounded-xl border shadow-sm p-6 dark:bg-gray-800">
                ...
                <div className="overflow-x-auto">
                  <Table>
                    <TableCaption>List of all service bookings</TableCaption>
                    <TableHeader>
                      <TableRow>
                  ...
                  <PaginationContent>
                    <PaginationItem>
                      <PaginationPrevious 
                        ...
                        className={bookingsPage === 1 ? "pointer-events-none opacity-50" : ""}
                      />
                    </PaginationItem>
                    
                    {[...Array(3)].map((_, i) => {
                      const page = bookingsPage - 1 + i;
            ...
            <TabsContent value="feedback">
              <div className="bg-white rounded-xl border shadow-sm p-6 dark:bg-gray-800">
                ...
                <div className="overflow-x-auto">
                  <Table>
                    <TableCaption>Recent customer feedback</TableCaption>
                    <TableHeader>
                      <TableRow>
                        <TableHead>Date</TableHead>
                        <TableHead>Customer</TableHead>
                  ...
                  <PaginationContent>
                    <PaginationItem>
                      <PaginationPrevious 
                        ...
                        className={feedbackPage === 1 ? "pointer-events-none opacity-50" : ""}
                      />
                    </PaginationItem>
                    
                    {[...Array(3)].map((_, i) => {
                      const page = feedbackPage - 1 + i;
                      if (page < 1) return null;
                      return (
                        <PaginationItem key={page}>
                          <PaginationLink 
